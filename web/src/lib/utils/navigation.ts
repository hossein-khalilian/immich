...
export const isAlbumsRoute = (route?: string | null) => !!route?.startsWith('/(user)/library/albums/[albumId=id]');
export const isFoldersRoute = (route?: string | null) => !!route?.startsWith('/(user)/library/folders/[folderId=id]');
